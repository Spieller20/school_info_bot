...
def func(message):
    ...
    #Меню выбранной даты урока
     ...
     bot.send_document(message.chat.id, document='https://docs.yandex.ru/docs/view?url=ya-disk%3A%2F%2F%2Fdisk%2FДля%20бота%2FДЗ%2F1%20кл%2010-14%20л.docx&name=1%20кл%2010-14%20л.docx&uid=50247010&nosw=1', caption='1 кл. внебюджет (10-14 лет) - расставить тактовые чёрточки')
