...
bot = TeleBot(token=TOKEN, threaded=True, num_threads=4)
...
def func(message):
    ...
    #Меню выбранной даты урока
     ...
     bot.send_message(message.chat.id,                      
                      "<b><i>1 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Рт. С. 29 номера 1,2, 4 (а, б)\n\n"
                      "<b><i>Слушание музыки:</i></b> Урок 15, письменно ответить на вопросы стр 107\n\n "
                      
                      "<b><i>2 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Рт. С. 21 номера 1,2,7\n\n"
                      "<b><i>Слушание музыки:</i></b> Уроки 11,13,15(выучить слова из кроссворда\n\n "
                      
                      "<b><i>3 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Рт. С. 15 номер 1. Построить все интервалы от нот до, ре\n\n"
                      "<b><i>Слушание музыки:</i></b> Уроки 12-15, подготовиться к тесту по творчеству Моцарта\n\n " 
                      
                      "<b><i>4 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Учебник, номера 34-40 петь с листа с дирижированием\n\n"
                      "<b><i>Музыкальная литература:</i></b> Урок 15, письменно ответить на вопросы стр 107\n\n"
                      
                      "<b><i>5 класс:</i></b>\n<b><i>Сольфеджио:</i></b> В любой тональности (кроме до мажора) найти и выписать тональности 1 степени родства"
                      "\n\n<b><i>Музыкальная литература:</i></b> Уроки 12-15, подготовиться к тесту по творчеству Моцарта\n\n "
                      
                      "<b><i>6 класс:</i></b>\n<b><i>Сольфеджио:</i></b> В учебнике номера 34-40 петь с листа с дирижированием"
                      "\n\n<b><i>Музыкальная литература:</i></b> стр 276-277, вопросы 1-11 письменно в тетради\n\n "
                      
                      "<b><i>7 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Рт. С. 26 номер 23 (а)"
                      "\n\n<b><i>Музыкальная литература:</i></b> Урок 33 читать, ответить в вопросы письменно\n\n "
                      
                      "<b><i>8 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Класса нет"
                      "\n\n<b><i>Музыкальная литература:</i></b> Класса нет\n",
                         parse_mode='HTML')

     bot.send_message(message.chat.id, "<b><i>1 кл. внебюджет, сольфеджио (7-9 лет):</i></b> Рт. С. 29 номера 1,2, 4 (а, б)\n", parse_mode='HTML')
     bot.send_message(message.chat.id, "<b><i>1 кл. внебюджет, сольфеджио (10-14 лет):</i></b> В тетради построить ув53 и ум53 от всех белых клавиш\n", parse_mode='HTML')

    elif(message.text == "28 февраля 2026"):     
     bot.send_message(message.chat.id,                      
                      "<b><i>1 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Задания нет\n\n"
                      "<b><i>Слушание музыки:</i></b> Уроки 16-17 стр 108-113, выписать танцы народов мира\n\n "
                      
                      "<b><i>2 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Задания нет\n\n"
                      "<b><i>Слушание музыки:</i></b> Уроки 15,16, выучить слова\n\n "
                      
                      "<b><i>3 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Задания нет\n\n"
                      "<b><i>Слушание музыки:</i></b> Уроки 16-17, биография Бетховена в таблице\n\n " 
                      
                      "<b><i>4 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Задания нет\n\n"
                      "<b><i>Музыкальная литература:</i></b> Уроки 16-17, стр 108-113, выписать танцы народов мира\n\n"
                      
                      "<b><i>5 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Задания нет"
                      "\n\n<b><i>Музыкальная литература:</i></b> Уроки 16-17, таблица биография Бетховена в таблице\n\n "
                      
                      "<b><i>6 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Задания нет"
                      "\n\n<b><i>Музыкальная литература:</i></b> стр 276-278 вопросы 1-24 письменно\n\n "
     ...
     bot.send_message(message.chat.id, "<b><i>1 кл. внебюджет, сольфеджио (7-9 лет):</i></b> Задания нет\n", parse_mode='HTML')
     bot.send_message(message.chat.id, "<b><i>1 кл. внебюджет, сольфеджио (10-14 лет):</i></b> Задания нет\n", parse_mode='HTML')

    elif(message.text == "7 марта 2026"):     
     bot.send_message(message.chat.id,           
                      "<b><i>1 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Рт. С. 29 номер 4 (в, г)\n\n"
                      "<b><i>Слушание музыки:</i></b>\n\n "
                      
                      "<b><i>2 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Рт. С. 21 номера 3,4 + петь\n\n"
                      "<b><i>Слушание музыки:</i></b>\n\n "
                      
                      "<b><i>3 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Построить в тетради T, S, D с обращениями в тональности до мажор\n\n"
                      "<b><i>Слушание музыки:</i></b>\n\n " 
                      
                      "<b><i>4 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Диктант транспонировать в любую тональность и петь с дирижированием (сам диктант в сообщении ниже)\n\n"
                      "<b><i>Музыкальная литература:</i></b>\n\n"
                      
                      "<b><i>5 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Рт с. 24 номер 10"
                      "\n\n<b><i>Музыкальная литература:</i></b>\n\n "
                      
                      "<b><i>6 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Диктант транспонировать в любую тональность и петь с дирижированием (сам диктант в сообщении ниже)"
                      "\n\n<b><i>Музыкальная литература:</i></b>\n\n "
                      
                      "<b><i>7 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Номера 613, 615 в учебнике петь с дирижированием"
                      "\n\n<b><i>Музыкальная литература:</i></b> Урок 34 читать, ответить на вопросы.\n\n "
     ...
     bot.send_message(message.chat.id,
                      "<b><i>1 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Раскраска\n\n"
                      "<b><i>Слушание музыки:</i></b> Уроки 16-17, письменно ответить на вопросы стр 118\n\n "
                      
                      "<b><i>2 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Выписать в тетрадь определение обращения, построить в тетради мажорные и минорные трезвучия с обращениями от нот до и ре\n\n"
                      "<b><i>Слушание музыки:</i></b> Урок 17, повторить термины уроки 15-16\n\n "
                      
                      "<b><i>3 класс:</i></b>\n<b><i>Сольфеджио:</i></b> рт. с 23 Ля мажор, фа-диез минор сделать по образцу\n\n"
                      "<b><i>Слушание музыки:</i></b> Урок 18, письменно ответить на вопросы стр 140\n\n " 
                      
                      "<b><i>4 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Презентация: https://disk.yandex.ru/i/Exqyt5SdeAY5kQ\n\n"
                      "<b><i>Музыкальная литература:</i></b> Уроки 16-17, письменно ответить на вопросы стр 118\n\n"
                      
                      "<b><i>5 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Презентация: https://disk.yandex.ru/i/Exqyt5SdeAY5kQ"
                      "\n\n<b><i>Музыкальная литература:</i></b> Урок 18, письменно ответить на вопросы стр 140\n\n "
                      ...
                      "<b><i>7 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Презентация: https://disk.yandex.ru/i/FBnMipouqMnNyA"
                      "\n\n<b><i>Музыкальная литература:</i></b> Повторять записи в тетради\n\n "
    ...
    elif(message.text == "28, 30 марта 2026(locked)"):     
     bot.send_message(message.chat.id,
                      "<b><i>1 класс:</i></b>\n<b><i>Сольфеджио:</i></b>\n\n"
                      "<b><i>Слушание музыки:</i></b>\n\n "
