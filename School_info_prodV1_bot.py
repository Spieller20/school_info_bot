...
def func(message):
    ...
    #Меню выбранной даты урока
     ...
     bot.send_message(message.chat.id,
                      ...
                      "Слушание музыки: Шорникова «Музыкальная литература» 1 год
Введение «Музыка и мы», ответить на вопросы устно\n\n "
                      
                      "<b><i>2 класс:</i></b>\nСольфеджио: Р.т. С. 17 номер 11\n"
                      "Слушание музыки: Учебник: Царёва « Уроки госпожи Мелодии» 2 кл.
Выучить слова в тетради\n\n "
                      
                      "<b><i>3 класс:</i></b>\nСольфеджио: Рт. С. 7 До мажор сделать по образцу\n"
                      "Слушание музыки: Шорникова «Музыкальная литература» 2 год
Урок 1, стр. 4-6, ответить на вопросы устно\n\n " 
                      
                      "<b><i>4 класс:</i></b>\nСольфеджио: 4 класс Р.т. С. 7 номер 11 сделать в скрипичном ключе\n"
                      "Музыкальная литература: Шорникова «Музыкальная литература» 1 год
Введение «Музыка и мы», ответить на вопросы устно\n\n"
                      
                      "<b><i>5 класс:</i></b>\nСольфеджио: учебник Калмыков, Фридкин 1 часть, номер 275 выучить наизусть"
                      "\nМузыкальная литература: Учебник: Шорникова «Музыкальная литература» 2 год обучения
Урок 1, стр.4-6, ответить на вопросы устно\n\n "
                      
                      "<b><i>6 класс:</i></b>\nСольфеджио: Задания нет"
                      "\nМузыкальная литература: Учебник: Шорникова « Музыкальная литература» 2 год
Повторить уроки 1-20\n\n "
                      
                      "<b><i>7 класс:</i></b>\nСольфеджио: Задания нет"
                      "\nМузыкальная литература: Учебник: Шорникова «Музыкальная литература» 3 год
Урок 35, ответить на вопросы 1-10 письме\n\n "
