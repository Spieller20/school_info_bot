...
def func(message):
    ...
    #Меню выбранной даты урока
     ...
     bot.send_message(message.chat.id,
                      ...
                      "<b><i>5 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Задание прежнее"
                      "\n\n<b><i>Музыкальная литература:</i></b>\n\n Урок 14, письменно ответить на вопросы стр. 99 (1-4)"
                      
                      "<b><i>6 класс:</i></b>\n<b><i>Сольфеджио:</i></b> Учебник: №106 разобрать (по нему будет диктант)"
                      "\n\n<b><i>Музыкальная литература:</i></b>\n\n Урок 30, письменно ответить на вопросы стр. 268"
     ...
     bot.send_message(message.chat.id, "<b><i>1 кл. внебюджет, сольфеджио (7-9 лет):/i></b> Р.Т. с.25 №9 F-dur\n", parse_mode='HTML')
     bot.send_message(message.chat.id, "<b><i>1 кл. внебюджет, сольфеджио (10-14 лет): Р.Т. с.31 №16'A', 17</i></b>\n", parse_mode='HTML')
