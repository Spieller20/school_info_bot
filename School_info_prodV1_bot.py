...
def func(message):
    ...
    elif(message.text == "Октябрь(locked)"):
     markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
    ...
    #Меню выбранной даты урока
     ...
     bot.send_message(message.chat.id,
                      "<b><i>1 класс:</i></b>\nСольфеджио: Научиться писать нотку «до» первой октавы в нотной тетради. Для знающих ноты смотреть сообщение с картинкой.\n"
                      "Слушание музыки: Уроки 2-3, стр 11-16\n\n "
                      
                      "<b><i>2 класс:</i></b>\nСольфеджио: р.т. с. 6 номера 1, 2 ( на с.3. в этой же тетради есть все подсказки: что такое устойчивые и неустойчивые ступени, как подписывать римские цифры и т.д.)\n"
                      "Слушание музыки: Урок 22 1 кл.знать инструменты симфонического оркестра\n\n "
                      
                      "<b><i>3 класс:</i></b>\nСольфеджио: р.т. с. 7 по образцу сделать соль мажор\n"
                      "Слушание музыки:\n\n Урок 2, вопросы стр 10 письменно" 
                      
                      "<b><i>4 класс:</i></b>\nСольфеджио: р.т. с 7 номер 9 (весь) + подписать ступеньки римскими цифрами\n"
                      "Музыкальная литература: Уроки 2-3, стр 11-16\n\n"
                      
                      "<b><i>5 класс:</i></b>\nСольфеджио: учебник Калмыков-Фридкин (одноголосие) номер 275. Первое предложение (первые 4 такта) – записать в увеличении, т.е. каждая длительность увеличивается вдвое (восьмушка стала четвертью, четверть – половинкой и т.д.). Размер 4/4. Второе предложение (5-8 такты) записать в уменьшении. Размер 2/8. Дальше не надо."
                      "\nМузыкальная литература: Урок 2, письменно ответить на вопросы стр 10\n\n "
                      
                      "<b><i>6 класс:</i></b>\nСольфеджио: Смотреть сообщение с картинкой."
                      "\nМузыкальная литература: Повторить уроки 8-11, урок 21, письменно ответить на вопросы после 21 урока\n\n "
                      
                      "<b><i>7 класс:</i></b>\nСольфеджио: Смотреть сообщение с картинкой"
                      "\nМузыкальная литература: Урок 35, письменно ответить на вопросы 1-19\n\n "
                      
                      "<b><i>8 класс:</i></b>\nСольфеджио: Класса нет"
                      "\nМузыкальная литература: Класса нет\n",
                        parse_mode='HTML')
     ...
     bot.send_photo(message.chat.id, 'https://disk.yandex.ru/i/sVil6IJdZX1oXg', caption='6, 7 классы – пользуясь буквенными обозначениями подписать аккорды в гармонии')
    ...
    elif(message.text == "(locked)20, 22 сентября 2025"):     
     bot.send_message(message.chat.id,
                      "<b><i>1 класс:</i></b>\nСольфеджио:\n"
                      "Слушание музыки:\n\n "
