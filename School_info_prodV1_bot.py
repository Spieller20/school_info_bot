...
def func(message):
    ...
    #Меню выбранной даты урока
     ...
     bot.send_document(message.chat.id, 'https://disk.yandex.ru/i/9EMmXHuoA6bclw', caption='1 кл. внебюджет (10-14 лет) - расставить тактовые чёрточки')
