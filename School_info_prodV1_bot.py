...
def func(message):
    ...
    #Меню выбранной даты урока
     ...
     bot.send_message(message.chat.id,                      
                      ...
                      "\n\n<b><i>Музыкальная литература:</i></b>\n Класса нет",
                         parse_mode='HTML')
     bot.send_audio(message.chat.id, "https://disk.yandex.ru/d/iGXscLdo8WX6aw", caption='Диктант до мажор 4 и 6 классы')
     bot.send_audio(message.chat.id, "https://disk.yandex.ru/d/axc2WJjnjW1e2A", caption='Диктант ре минор 5 класс')
