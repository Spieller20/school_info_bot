...
def func(message):
    ...
    #Меню выбранной даты урока
     ...
     bot.send_message(message.chat.id,
                      ...
                      "<b><i>1 класс:</i></b>\nСольфеджио: Последний урок (задания нет)\n\n"
                      "Слушание музыки: урок 7, письменно ответить на вопросы стр 48\n\n"
                      
                      "<b><i>2 класс:</i></b>\nСольфеджио: Последний урок (задания нет)\n\n"
                      "Слушание музыки: урок 3\n\n"
                      
                      "<b><i>3 класс:</i></b>\nСольфеджио: Последний урок (задания нет)\n\n"
                      "Слушание музыки: уроки 2-7 повторить\n\n" 
                      
                      "<b><i>4 класс:</i></b>\nСольфеджио: Последний урок (задания нет)\n\n"
                      "Музыкальная литература: урок 7, письменно ответить на вопросы стр 48\n\n"
                      
                      "<b><i>5 класс:</i></b>\nСольфеджио: Последний урок (задания нет)"
                      "\n\nМузыкальная литература: уроки 2-7 повторить\n\n"
                      
                      "<b><i>6 класс:</i></b>\nСольфеджио: Последний урок (задания нет)"
                      "\n\nМузыкальная литература: уроки 21-25 повторить\n\n"
                      
                      "<b><i>7 класс:</i></b>\nСольфеджио: Последний урок (задания нет)"
                      "\n\nМузыкальная литература: уроки 17-18, письменно ответить на вопросы стр 169\n\n"
